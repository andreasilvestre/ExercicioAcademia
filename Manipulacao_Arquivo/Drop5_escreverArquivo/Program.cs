...
StreamWriter escritor = new StreamWriter(nomeArquivo, true); //abre o arquivo para escrita e com append/add mais dados
//StreamWriter escritor = new StreamWriter(nomeArquivo); // sem true => cria arquivo ou substitui/overrride o existente
